    ...
    public class GroundChecker
    {
        ...
        public void CheckGround()
        {
            ...
            IsGrounded = Physics.CapsuleCast(
                ...
                out hitInfo,
                settings.rayLength + controller.skinWidth,
        ...
        public Vector3 GetSlopeSlideDirection()
        {
            ...
            var slopeDirection = Vector3.ProjectOnPlane(-controller.transform.up, hitInfo.normal).normalized;
        ...
        public void DrawGroundCheckGizmo()
        {
            ...
            Gizmos.DrawLine(
                center,
                center + -controller.transform.up * (settings.rayLength + controller.skinWidth)
            );

            var endPoint = center + -controller.transform.up * (settings.rayLength + controller.skinWidth);
            DrawCapsuleGizmo(
